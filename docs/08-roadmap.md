...
- CLI UX contract — [ADR 0021](adr/0021-cli-ux-contract.md) (**Accepted**): Phase A `version`/help/exits/`doctor`/`status --json` (**landed** — [17-cli.md](user/17-cli.md)); Phase B `backup`/`restore`/`update`/`recyclarr`/completions; Phase C taxonomy hardening
