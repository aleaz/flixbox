...
Use the correct qBit URL for your mode (`gluetun` vs `qbittorrent`). Decluttarr auth uses qBit **username/password** in `.env`, not the qBit API key — [Credentials](06-configuration.md#credentials-and-api-keys).
