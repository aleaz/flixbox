...
_flixbox_completions() {
  ...
  local profiles="plex proxy recyclarr notifications vpn-heal"
...
_flixbox() {
  ...
  profiles=(plex proxy recyclarr notifications vpn-heal)
    ...
    args)
      case $words[1] in
        ...
        restore)
          ...
          ;;
        update|up|reload)
          _arguments '--dry-run' '-h' '--help' '--profile:profile:(plex proxy recyclarr notifications vpn-heal)' '*:profile:(plex proxy recyclarr notifications vpn-heal)'
          ;;
        configure)
